...
import { todoStore } from "@/piniaStore/index"
...
const resetLocalStorage = () => {
  ...
  // store.$patch((storeState: any) => {
  //   storeState.todoList = [...state.list]
  // })
  // store.$state.todoList = state.list
  store.changeState(state.list)
